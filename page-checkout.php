    ...
    <div class="tour-booking-detail-main-container">
        ...
        <div class="tour-switch-user">
          <p class="tour-switch-user-current-user">
            ...
            <span>
              ...
              <span class="tour-switch-user-current-user-name">account name</span>
            </span>
          </p>
          <p data-translate-key="Switch user" class="tour-switch-user-button">
            Switch user
          </p>
        </div>
      ...
      <div class="tour-booking-detail-section">
        ...
        <div class="tour-booking-button">
          <button data-translate-key="BOOK NOW">BOOK NOW</button>
        </div>
      </div> 
    </div>
      ...
      <div class="tour-detail-book-container">
        <div class="tour-booking-sidebar-tourInfo">
          ...
          <div class="tourInfo-title">
            <h2>Essential tour for fashion and art in Tokyo..</h2>
          </div>
          <div class="tourInfo-price">
            ¥66,472.00
          </div>
        </div>
        <div class="tour-info-desc-detail-info">
