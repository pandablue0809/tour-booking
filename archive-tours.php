    ...
    <div class="tour-list container">
        ...
        <div class="tour-result">
            <h2 class="tour-result-title">
                <span class="translate" data-name-en="Things to do in Japan" 
                data-name-jp="日本でやるべきこと">Things to do in Japan</span>
            ...
            <div class="tour-result-slick-list">
                <div class="tour-result-slick-list-title">
					...
					<span class="translate" data-name-en="Nationwide's popular activity" 
                data-name-jp="全国で人気のアクティビティ">Nationwide's popular activity</span>
                </div>
